...
import '../TeacherDashboard/Addproduct.css'
...
function UpStudent() {
  ...
  async function getProductList() {
    ...
    let responce = await fetch(`http://localhost:8081/student/product/${param.id}`);
  ...
  async function handleSubmit(e) {
    ...
    let data = await fetch(`http://localhost:8081/student/product/${param.id}`, {
      method: 'PUT',
